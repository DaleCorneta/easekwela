...
import SectionSettingFormDrawer from "@/Components/SectionSettingFormDrawer";

export default function Index({ settings, sections }) {
    ...
    const deleteSetting = () => {
        router.visit(route("section-settings.destroy", settingToDelete.id), {
            method: "delete",
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        ...
        >
                        ...
                        <div className="p-4 flex flex-wrap items-center justify-between gap-4">
                            <div className="relative w-full max-w-96">
                                ...
                                <input
                                    ...
                                    placeholder="Search by group, key or section..."
            ...
            <Modal
                ...
                message={`Are you sure you want to delete the setting for "${settingToDelete?.key}"?`}
                confirmText="Delete"
                variant="danger"
            />
        </AuthenticatedLayout>
